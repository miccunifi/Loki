...
define("EW_CONN_USER", "micc-interface", TRUE);
define("EW_CONN_PASS", "59JWfEG5QM7U22CD", TRUE);
...
define("EW_VIDEO_PATH", '/var/www/search-interface/media/video/', TRUE);
define("EW_AUDIO_PATH", '/var/www/search-interface/media/audio/', TRUE);
define("EW_IMAGE_PATH", '/var/www/search-interface/media/image/', TRUE);

define("EW_AUDIO_HTTP_URL", 'http://shrek.micc.unifi.it/search-interface/media/audio/', TRUE);
define("EW_IMAGE_HTTP_URL", 'http://shrek.micc.unifi.it/search-interface/media/image/', TRUE);
define("EW_VIDEO_HTTP_URL", 'http://shrek.micc.unifi.it/search-interface/media/video', TRUE);
...
define("EW_DOCUMENT_HTTP_URL", 'http://shrek.micc.unifi.it/search-interface/media/document/', TRUE);
define("EW_DOCUMENT_SVG_HTTP_URL", 'http://shrek.micc.unifi.it/search-interface/media/document_svg/', TRUE);
define("EW_DOCUMENT_THUMB_HTTP_URL", 'http://shrek.micc.unifi.it/search-interface/media/document_thumb/', TRUE);
