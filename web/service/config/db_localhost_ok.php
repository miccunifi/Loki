...
define("EW_ABS_MEDIA_PATH", '/var/www/eutv-data/media/', TRUE);

//define data mpeg7 folder
define("EW_DATAMPEG7_PATH", '/var/www/eutv-data/media/data/', TRUE);
define("EW_VIDEO_PATH", '/var/www/eutv-data/media/video/', TRUE);
define("EW_AUDIO_PATH", '/var/www/eutv-data/media/audio/', TRUE);
define("EW_IMAGE_PATH", '/home/lorenzo/Documenti/localhost/micc/media/image/', TRUE);

define("EW_AUDIO_HTTP_URL", 'http://localhost/eutv/media/audio/', TRUE);
define("EW_IMAGE_HTTP_URL", 'http://localhost/eutv/media/image/', TRUE);
define("EW_VIDEO_HTTP_URL", 'http://localhost/eutv/media/video/', TRUE);
...
define("EW_DOCUMENT_HTTP_URL", 'http://localhost/eutv/media/document/', TRUE);
define("EW_DOCUMENT_SVG_HTTP_URL", 'http://shrek.micc.unifi.it/eutv-data/media/document_svg/', TRUE);
define("EW_DOCUMENT_THUMB_HTTP_URL", 'http://shrek.micc.unifi.it/eutv-data/media/document_thumb/', TRUE);

define("EW_DOCUMENT_THUMB_ABS_PATH_URL", '/var/www/eutv-data/media/document_thumb/', TRUE);
