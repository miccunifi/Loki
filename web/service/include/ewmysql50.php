...
/**
 * MySQL API for PHPMaker 5+
 * (C) 2002-2007 e.World Technology Limited
 *
 * This script (ewmysql50.php) is based on:
 * V1.42 ADOdb Lite 11 January 2007 (C) 2005-2007 Mark Dickenson. Released LGPL.
 */
$PHPMaker_vers = 'v5.0.0 PHPMaker (C) 2002-2007 e.World Technology Limited';
